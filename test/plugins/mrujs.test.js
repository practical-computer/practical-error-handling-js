...
import * as MrujsPlugins from '@practical-computer/error-handling/plugins/mrujs'


suite('Mrujs Plugin', async () => {
  test(`does nothing if the event's response status != 422`, async () => {
    ...
    const event = new CustomEvent(`ajax:response:error`, {
      detail: {
        element: form,
        response: response
      }
